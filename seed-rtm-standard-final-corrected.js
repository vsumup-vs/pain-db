...
// Safe delete function with proper model names
async function safeDelete(modelName, tableName) {
  try {
    ...
    if (error.code === 'P2002') {
      console.log(`⚠️ Foreign key constraint prevented deletion from ${tableName}`);
    } else {
...
async function seedRTMStandardFinalFixed() {
  try {
    ...
    // Create/update metric definitions with correct field mapping
    ...
    // Create/update standardized condition presets
